...
const OPENAI_LIVE_SCAN_PROMPT = [
  ...
  '',
  'CATEGORY 1 SMALL DENT (<30mm, any panel): tiny reflection pinch → dent_category=1, size_score=1, dent_type=soft_dent.',
  'CATEGORY 2 DEEP DING / MEDIUM DENT (31-60mm, ANY panel — door, bonnet, guard, boot, quarter, roof, sill):',
  '  defined indentation with strong reflection warp (figure-8, hourglass, pinched light lines),',
  '  OR shallow horizontal crease near panel seam under 60mm, paint intact →',
  '  dent_category=2, size_score=2, stress_score=1-2, dent_type=sharp_dent or soft_dent.',
  'Do NOT use crease_dent/bodyline_dent for Category 2 — only for damage over 90mm with heavy stress.',
  'CATEGORY 3 MODERATE/DEEP DENT (61-90mm, ANY panel): body line kink, V-crease, large bowl, fender arch dent →',
  '  dent_category=3, size_score=3, stress_score=2-3, dent_type=sharp_dent or edge_dent.',
  'Do NOT use bodyline_dent for Category 3 — only for creases over 160mm.',
  'CATEGORY 4 LARGE CREASE (91-160mm, ANY panel): long horizontal crease, deep body-line crease, pintura lascada →',
  '  dent_category=4, size_score=3, stress_score=3-4, dent_type=crease_dent or sharp_dent.',
  'Pintura lascada: still Cat 4 dent estimate; needs_paint_repair=true, paint quoted separately.',
  'CATEGORY 5 MAJOR CREASE (161-260mm): tailgate/door sharp fold, dual-panel edge, pintura lascada →',
  '  dent_category=5, size_score=4, stress_score=3-4, dent_type=crease_dent or bodyline_dent.',
  'Accept analysis with paint damage — shop quotes PDR + paint separately.',
  'CATEGORY 6 SEVERE PANEL DAMAGE (261-400mm): boot/trunk crease, bodyline collapse, guard peak, quarter crease →',
  '  dent_category=6, size_score=4-5, stress_score=4-5, dent_type=bodyline_dent or collapsed_dent.',
  'Pintura lascada: accept analysis; needs_paint_repair=true; shop adds paint to PDR quote.',
  'CATEGORY 7 EXTREME (400-600mm): full-height door crease, shut-line vertical fold, massive bumper →',
  '  dent_category=7, size_score=5, stress_score=4-5, dent_type=crease_dent or bumper_damage.',
    ...
    if (isOpenAIConfigured()) {
      try {
        ...
        const { category, reasons } = resolveCategory({
          ...
          locationScore: aiResult.location_score,
          dentType: aiResult.dent_type,
          severity: aiResult.severity,
          panelDetected: aiResult.panel_detected,
          damageHeightPct: (aiResult as any).damage_height_pct,
          damageWidthPct: (aiResult as any).damage_width_pct,
          creaseOrientation: (aiResult as any).crease_orientation,
        });
